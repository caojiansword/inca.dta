...
(function(factory){
  ...
  Datetimepicker.prototype = {
    ...
    fill: function () {
      ...
      this.picker.find('tfoot th.todayNight')
      .text("今天23点");
        ...
        switch (target[0].nodeName.toLowerCase()) {
          case 'th':
            switch (target[0].className) {
              ...
              case 'todayNight':
                  var date = new Date();
                  date = UTCDate(date.getFullYear(), date.getMonth(), date.getDate(), 23, 59, 59, 0);
  ...
  var DPGlobal = {
    ...
    footTemplate: '<tfoot>' + 
                    '<tr><th colspan="3" class="today"></th><th colspan="4" class="todayNight"></th></tr>' +
